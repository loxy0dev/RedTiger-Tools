...
{color.WHITE}[{color.RED}03{color.WHITE}] {color.RED}->{color.WHITE} Other
""")
...
{color.WHITE}[{color.RED}08{color.WHITE}] {color.RED}->{color.WHITE} Doxbin.net
{color.WHITE}[{color.RED}09{color.WHITE}] {color.RED}->{color.WHITE} Back
""")
while True:
    ...
    if choice in ['08', '8']:
        webbrowser.open("https://doxbin.net/search")
