...
email = input(f"\n{INPUT} Email -> {reset}")
print(f"""
{white}[{red}01{white}] {red}->{white} Chrome
{white}[{red}02{white}] {red}->{white} Firefox
{white}[{red}03{white}] {red}->{white} Edge
""")
...
print(f"""
{red}The email "{white}{email}{red}" are in the database of:
