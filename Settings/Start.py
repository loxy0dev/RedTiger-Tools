try:
 ...
 while True:
   ...
   {color.WHITE}[{color.RED}03{color.WHITE}] {color.RED}->{color.WHITE} Ip Info                        {color.WHITE}[{color.RED}13{color.WHITE}] {color.RED}->{color.WHITE} Discord Token Info             {color.WHITE}[{color.RED}23{color.WHITE}] {color.RED}->{color.WHITE} Discord Bot Server Nuker (soon)
   ...
   {color.WHITE}[{color.RED}06{color.WHITE}] {color.RED}->{color.LIGHTYELLOW_EX} Discord/System/Browser Grab    {color.WHITE}[{color.RED}16{color.WHITE}] {color.RED}->{color.WHITE} Discord Mass Dm                {color.WHITE}[{color.RED}26{color.WHITE}] {color.RED}->{color.WHITE} Number Info
   ...
   {color.WHITE}[{color.RED}10{color.WHITE}] {color.RED}->{color.WHITE} Discord Webhook Create         {color.WHITE}[{color.RED}20{color.WHITE}] {color.RED}->{color.WHITE} Discord Theme Changer          {color.WHITE}[{color.RED}30{color.WHITE}] {color.RED}-> Next Page                                       
